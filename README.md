...
| `latitude`      | (Dentro de `localizacao`) Especifica a coordenada de latitude do local, representada por um valor do tipo COORDINATE.                                                                                                                                                                                                |
| `longitude`     | (Dentro de `localizacao`) Especifica a coordenada de longitude do local, representada por um valor do tipo COORDINATE.                                                                                                                                                                                               |
...
| `COORDINATE` | Representa uma coordenada geográfica (latitude ou longitude). É um número decimal positivo ou negativo com precisão de até 8 casas decimais. Latitude varia de -90 a 90 e longitude de -180 a 180 (ex: -34.56789, 78.12345). |
